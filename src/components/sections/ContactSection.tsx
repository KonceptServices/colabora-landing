    ...
    <section id="contact" className="pb-24">
      <div className="container mx-auto px-6 max-w-4xl text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center max-w-2xl mx-auto">
          ...
          <Button
            className="w-full sm:w-auto bg-gray-300 hover:bg-gray-400 text-gray-900 font-medium text-lg px-8 py-6 rounded-full min-w-[280px] h-16 flex items-center justify-between transition-all duration-300"
            onPress={() => window.open(contactData.scheduleCall.url, '_blank')}
          >
            <span className="flex-1 text-center font-poppins text-md">{contactData.scheduleCall.text}</span>
          ...
          >
            <span className="flex-1 text-center font-poppins text-md">{contactData.sendMessage.text}</span>
            <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center ml-4">
              <svg 
                width="20" 
                height="20" 
